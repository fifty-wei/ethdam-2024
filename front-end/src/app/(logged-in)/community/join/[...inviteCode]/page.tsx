...
export default function InviteCode() {
  ...
  useEffect(() => {
    ...
    getInvitationCode();
  }, [inviteCode, alreadyRedeem, address]);
  ...
  return isAccepted ? (
    <>
      <div className="bg-background relative min-h-screen isolate overflow-hidden">
        ...
        <div className="mx-auto flex items-center justify-center max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
          <div className="mx-auto flex flex-col gap-8 items-center text-center max-w-6xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
