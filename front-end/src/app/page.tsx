      ...
      <div className="bg-gray-900">
        <main>
          ...
          <div className="relative isolate overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-24 pt-10  lg:flex lg:px-8 gap-24 lg:pt-20">
              ...
              <div className="mx-auto w-1/2 gap-8 grid items-center grid-cols-2 mt-16 flex max-w-2xl sm:mt-24 lg:ml-0 lg:mt-0 lg:max-w-none lg:flex-none">
                <Link href="/book/1">
