            ...
            <section className="container mx-auto max-w-7xl px-6 pb-24 pt-10  lg:flex lg:px-8 gap-24 lg:pt-20">
              <div className="mx-auto max-w-2xl flex-shrink-1 lg:mx-0 lg:max-w-xl lg:pt-8">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Publish, Engage, Innovate: Write and fund your books chapter
                  by chapter on #Bhook (or other creation). Share previews,
                  gather feedback, and transform your words into exclusive NFTs
                  for your community.
                </p>
              ...
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl sm:text-center">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-300">
                    ...
                    new possibilities with #Bhook. Our platform is designed to
                    help you create, connect, and publish with ease.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
                  Please contact us at hello@fiftywei.co or visit our website
                  below
                </p>
