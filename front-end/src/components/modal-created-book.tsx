                                    ...
                                    { ! isSuccess ? (
                                        <>
                                            <figure className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-yellow-100">
                                                <RefreshCw className="h-6 w-6 text-yellow-600 animate-spin -scale-1" aria-hidden="true" />
                                            </figure>
                                            <div className="mt-3 text-center sm:mt-5">
                                                <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
                                                    Book currently being created
                                                </Dialog.Title>
                                                <div className="mt-2">
                                                    <p className="text-sm text-gray-500">
                                                        Please be patient, you will be able to write your first chapter shortly.
                                                    </p>
                                                </div>
                                            </div>
                                        </>
